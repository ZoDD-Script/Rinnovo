  ...
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`fex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <div className='flex flex-row justify-between items-center w-full'>
        <h1 className='flex-1 font-poppins font-semibold ss:text-[62px] text-[32px] text-white ss:leading-[100px] leading-[55px]'>
      ...
      <h1 className='font-poppins font-semibold ss:text-[58px] text-[32px] text-white ss:leading-[100px] leading-[55px] w-full'>
